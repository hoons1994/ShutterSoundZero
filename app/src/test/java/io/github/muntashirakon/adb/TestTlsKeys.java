...
final class TestTlsKeys {
    final java.security.KeyPair keys;
    final X509Certificate certificate;
    TestTlsKeys() throws Exception { this(2048, -60_000, 86_400_000, false); }
    TestTlsKeys(int bits, long start, long end, boolean wrongSigner) throws Exception {
