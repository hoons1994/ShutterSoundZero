...
[![Version](https://img.shields.io/badge/Version-1.4.4-orange.svg)](https://github.com/hoons1994/ShutterSoundZero/releases/latest)
...
5. **🔄 재부팅 및 소프트웨어 업데이트 상태 확인**
   ...
   * 시스템 보안 설정 권한까지 해제된 경우 메인 화면에서 [1회 설정 시작]을 다시 진행해야 합니다.
